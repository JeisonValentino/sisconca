 ...
 */
@Entity
@Table(name = "renovacion_auditoria")
public class RenovacionAuditoria implements Serializable{
    ...
    @Basic(optional = false)
    @Column(name = "idCodigoOrigen", unique = true)
    private Integer idCodigoOrigen;
    ...
    public Integer getIdCodigoOrigen() {
        return idCodigoOrigen;
    }

    public void setIdCodigoOrigen(Integer idCodigoOrigen) {
