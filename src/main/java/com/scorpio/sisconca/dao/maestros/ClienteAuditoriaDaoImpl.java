 ...
 * @author YVAN
 */
@Repository("clienteAuditoriaDao")
public class ClienteAuditoriaDaoImpl extends GenericEntityDaoImpl<ClienteAuditoria, Serializable> implements ClienteAuditoriaDao {

    @Override
    public List listarPorFecha(Auditoria auditoria) throws Exception {
        StringBuilder consulta = new StringBuilder();
        Map<String, Object> param = new HashMap<>();
        consulta.append("from ClienteAuditoria t where t.id is not null ");
    ...
    public Long getCountLazy(Auditoria auditoria) throws Exception {
        ...
        consulta.append("select count(*) from ClienteAuditoria t where t.id is not null ");
