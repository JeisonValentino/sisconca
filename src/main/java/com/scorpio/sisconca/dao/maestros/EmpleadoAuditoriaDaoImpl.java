 ...
 * @author YVAN
 */
@Repository("empleadoAuditoriaDao")
public class EmpleadoAuditoriaDaoImpl extends GenericEntityDaoImpl<EmpleadoAuditoria, Serializable> implements EmpleadoAuditoriaDao {

    @Override
    public List listarPorFecha(Auditoria auditoria) throws Exception {
        StringBuilder consulta = new StringBuilder();
        Map<String, Object> param = new HashMap<>();
        consulta.append("from EmpleadoAuditoria t where t.id is not null ");
    ...
    public Long getCountLazy(Auditoria auditoria) throws Exception {
        ...
        consulta.append("select count(*) from EmpleadoAuditoria t where t.id is not null ");
