 ...
 * @author YVAN
 */
@Repository("renovacionAuditoriaDao")
public class RenovacionAuditoriaDaoImpl extends GenericEntityDaoImpl<RenovacionAuditoria, Serializable> implements RenovacionAuditoriaDao{

    @Override
    public List listarPorFecha(Auditoria auditoria) throws Exception {
        StringBuilder consulta = new StringBuilder();
        Map<String, Object> param = new HashMap<>();
        consulta.append("from RenovacionAuditoria t where t.id is not null ");
        ...
        if (auditoria.getSedeId().getId() != null) {
            ...
            consulta.append(" and t.idSede.id = :sede_id");
        }
    ...
    public Long getCountLazy(Auditoria auditoria) throws Exception {
        ...
        consulta.append("select count(*) from RenovacionAuditoria t where t.id is not null ");
