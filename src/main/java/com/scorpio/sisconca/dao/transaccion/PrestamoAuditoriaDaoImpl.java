 ...
 * @author YVAN
 */
@Repository("prestamoAuditoriaDao")
public class PrestamoAuditoriaDaoImpl extends GenericEntityDaoImpl<PrestamoAuditoria, Serializable> implements PrestamoAuditoriaDao {

    @Override
    public List listarPorFecha(Auditoria auditoria) throws Exception {
        StringBuilder consulta = new StringBuilder();
        Map<String, Object> param = new HashMap<>();
        consulta.append("from PrestamoAuditoria t where t.id is not null ");
    ...
    public Long getCountLazy(Auditoria auditoria) throws Exception {
        ...
        consulta.append("select count(*) from PrestamoAuditoria t where t.id is not null ");
